...
impl Renderer {
    pub fn new(event_loop: &ActiveEventLoop, title: &str) -> Self {
        ...
        let vertex_buffer = vertex_buffer!(&ctx,
            Vertex { pos: [-0.5,-0.5,0.0], color: [1.0,0.0,0.0] }, // 0
            Vertex { pos: [0.5,-0.5,0.0],  color: [0.0,1.0,0.0] }, // 1
            Vertex { pos: [-0.5,0.5,0.0],  color: [0.0,0.0,1.0] }, // 2
            Vertex { pos: [0.5,0.5,0.0],   color: [1.0,0.0,1.0] }, // 3
            Vertex { pos: [0.8,0.0,0.0],   color: [0.1,1.0,1.0] }, // 4
